...
public class TransactionElement implements Serializable{
	...
	public TransactionElement copy() {
		TransactionElement copy = new TransactionElement(this.parserCursor.copy(), this.resetMatchedWithConsumed);
		copy.tokenKind = this.tokenKind;
		copy.tokens.addAll(this.tokens);
		return copy;
	}
}