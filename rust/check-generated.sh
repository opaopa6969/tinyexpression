...
#   1. src/generated/ubnfc/ against a fresh ubnfc generation at the pin in rust/ubnfc-pin.txt
...
#      rust/ubnfc-vendored.sha256 that --write records, which still catches hand edits;
