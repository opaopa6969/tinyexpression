...
const jarFrom = path.join(__dirname, "..", "server", "target", "tinyexpression-lsp-server.jar");
const jarTo = path.join(__dirname, "..", "server-dist", "tinyexpression-lsp-server.jar");
