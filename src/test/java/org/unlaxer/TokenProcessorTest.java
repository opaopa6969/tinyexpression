...
public class TokenProcessorTest {
  ...
  public static void main(String[] args) {
    ...
    RangedString rangedString = new RangedString(new Range(0,2),"abc");

    ABCParser abcParser = new ABCParser("abc");
  ...
  public static class ABCParser extends WordParser{

    public ABCParser(String word) {
      super(word);
    }

    public Token changeToken(Token token) {

      token.putExtraObject(Name.of("type"), String.class);
      return token;
    }
...
//        child.parser.setParent(parser);
    ...
    public void accept(Consumer<Token> tokenConsumer) {
      tokenConsumer.accept( this);
    }

    public Token apply(UnaryOperator<Token> tokenFunction) {
      return tokenFunction.apply(this);
    }

    public <T> T apply(Function<Token,T> tokenFunction) {
      return tokenFunction.apply(this);
    }
