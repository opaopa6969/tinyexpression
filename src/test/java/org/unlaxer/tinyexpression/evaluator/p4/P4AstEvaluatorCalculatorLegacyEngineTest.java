 ...
 */
public class P4AstEvaluatorCalculatorLegacyEngineTest extends CalculatorImplTest {
  ...
  public Calculator preConstructedCalculator(Source formula) {
    String className = "P4AstLegacyTest_CalculatorClass" + Math.abs(formula.source().hashCode());
