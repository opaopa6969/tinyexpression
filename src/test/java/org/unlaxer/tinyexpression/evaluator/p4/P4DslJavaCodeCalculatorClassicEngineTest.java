 ...
 */
public class P4DslJavaCodeCalculatorClassicEngineTest extends CalculatorImplTest {
  ...
  public Calculator preConstructedCalculator(Source formula) {
    String className = "P4DslClassicTest_CalculatorClass" + Math.abs(formula.source().hashCode());
