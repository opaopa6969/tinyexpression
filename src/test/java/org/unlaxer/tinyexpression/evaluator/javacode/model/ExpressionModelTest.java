...
import org.unlaxer.ast.ASTNodeMappings;
import org.unlaxer.context.ParseContext;
import org.unlaxer.parser.ParentHolderParser;
...
//      setASTNodeKind(Name.classBaseOf(this),ASTNodeKind.Operand);
    ...
    public Parsers getLazyParsers() {
      return Parsers.of(
          new ParentHolderParser(NTermParser.class)
...
//    );
    ...
    public Parsers getLazyParsers() {
      return Parsers.of(
          new ParentHolderParser(NFactorParser.class)
            .setOperand(),
//              .setASTNodeMapping(nodeMapping.get(TokenKind.LeftOperand.get())),
          new ZeroOrMore(
              new Chain(
...
//
  ...
  public static void main(String[] args) {
    ...
    Parsers flatten = nExpressionParser.flatten();
    
    for(Parser parser : flatten) {
      System.out.println(parser.getParent().map(Parser::getPath).orElse("")+" / " +parser.getPath());
    }
  }
