...
//    testPartialMatch(variableDeclarationParser, "variable $taxRate as number set 10.0 description='税率をセットします。';//税率が決め打ちだったので変数化" , "variable $taxRate as number set 10.0 description='税率をセットします。';");
    testUnMatch(variableDeclarationParser, "variable $taxRate as number set 10.0 description='税率をセットします。';//税率が決め打ちだったので変数化");
    testUnMatch(variableDeclarationParser, "var $taxRate as number set 10.0 description='税率をセットします。';//税率が決め打ちだったので変数化");
    testUnMatch(variableDeclarationParser, "var $age as number set if not exists 18 description='年齢をセットします。';");
    testUnMatch(variableDeclarationParser, "var $age number set 18 description='年齢をセットします。';");
