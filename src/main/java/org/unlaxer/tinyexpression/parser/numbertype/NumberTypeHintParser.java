...
public class NumberTypeHintParser extends LazyChoice implements org.unlaxer.tinyexpression.parser.TypeHint {
  ...
  @Override
  public org.unlaxer.tinyexpression.parser.ExpressionType type() {
    return org.unlaxer.tinyexpression.parser.ExpressionTypes.number;
  }

  public static ExpressionType expressionType(TypedToken<NumberTypeHintParser> token) {

    TypedToken<NumberClassParser> typed = ChoiceInterface.choiced(token)
        .typed(NumberClassParser.class);
    return NumberClassParser.expressionType(typed);
  }
