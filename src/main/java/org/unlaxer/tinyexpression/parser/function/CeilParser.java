...
public class CeilParser extends JavaStyleDelimitedLazyChain implements NumberExpression {
	...
	public static class CeilFuctionNameParser extends SuggestableParser {

		private static final long serialVersionUID = 1L;

		public CeilFuctionNameParser() {
			super(true, "ceil");
		}
	...
	public Parsers getLazyParsers() {
		return new Parsers(
			Parser.get(CeilFuctionNameParser.class),
