...
public class AbsParser extends JavaStyleDelimitedLazyChain implements NumberExpression {
	...
	public static class AbsFuctionNameParser extends SuggestableParser {

		private static final long serialVersionUID = 1L;

		public AbsFuctionNameParser() {
			super(true, "abs");
		}
	...
	public Parsers getLazyParsers() {
		return new Parsers(
			Parser.get(AbsFuctionNameParser.class),
