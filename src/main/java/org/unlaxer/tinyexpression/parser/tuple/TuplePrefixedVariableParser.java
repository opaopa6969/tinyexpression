...
public class TuplePrefixedVariableParser extends JavaStyleDelimitedLazyChain implements TupleExpression , VariableParser {


  public TuplePrefixedVariableParser() {
    super();
  }
