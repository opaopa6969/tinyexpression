...
public class LegacyOperatorOperandTreeCreator implements TokenReConstructorInterface{
  
  public static LegacyOperatorOperandTreeCreator SINGLETON = new LegacyOperatorOperandTreeCreator();
...
//      System.out.println(path);
    ...
    if(parser instanceof NumberVariableDeclarationParser ||
        ...
        parser instanceof NakedVariableDeclarationParser) {
    ...
    if(parser instanceof BooleanSetterParser||
        ...
        parser instanceof ObjectSetterParser) {
    ...
    if(parser instanceof ObjectVariableParser) {
      return token;
    }
