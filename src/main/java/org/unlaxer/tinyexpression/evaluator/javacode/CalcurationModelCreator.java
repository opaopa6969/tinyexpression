...
import org.unlaxer.tinyexpression.evaluator.javacode.model.CalcurationModel;
...
import org.unlaxer.tinyexpression.parser.booltype.BooleanCaseExpressionParser;
import org.unlaxer.tinyexpression.parser.booltype.BooleanCaseFactorParser;
import org.unlaxer.tinyexpression.parser.booltype.BooleanDefaultCaseFactorParser;
...
import org.unlaxer.tinyexpression.parser.numbertype.NumberCaseFactorParser;
...
import org.unlaxer.tinyexpression.parser.stringtype.StringCaseExpressionParser;
import org.unlaxer.tinyexpression.parser.stringtype.StringCaseFactorParser;
import org.unlaxer.tinyexpression.parser.stringtype.StringDefaultCaseFactorParser;
...
import org.unlaxer.tinyexpression.parser.stringtype.StringMultipleParameterPredicator;
...
@TokenReConstructor
public class CalcurationModelCreator {

  public static CalcurationModelCreator SINGLETON = new CalcurationModelCreator();


  public CalcurationModel apply(CalcurationModel calcurationModel) {

    Token token = calcurationModel.token();
...
//    }
    ...
    if(parser instanceof TinyExpressionParser) {
      ...
      JavaCodes extractCodes = TinyExpressionParser.extractCodesToken(tinyExpressionToken);

      Token extractImports = TinyExpressionParser.extractImportsToken(tinyExpressionToken);
