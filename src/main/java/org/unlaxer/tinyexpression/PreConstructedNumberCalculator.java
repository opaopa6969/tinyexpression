...
public abstract class PreConstructedNumberCalculator implements NumberCalculator {
...
//	}
  ...
  public PreConstructedNumberCalculator(String formula, String name , boolean createToken) {
    super();
...
//      System.out.println(rootTokenOutput);
  ...
  private PreConstructedNumberCalculator() {
    super();
