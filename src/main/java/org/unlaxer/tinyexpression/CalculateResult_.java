...
public class CalculateResult_{
  ...
  public CalculateResult_(ParseContext parseContext , Parsed parsed, Optional<BigDecimal> answer , Errors errors , Token operatorOperandTreeToken) {
    super();
  ...
  public CalculateResult_(ParseContext parseContext , Parsed parsed, Optional<BigDecimal> answer, Token operatorOperandTreeToken) {
