...
import org.unlaxer.ASTNodeContainer;
...
//  }
  ...
  public default Parser removeObject(Name name) {
    return removeObject(name.getName());
  }
  
  public default Parser removeObject(String name) {
    objectByName().remove(name);
    return this;
  }
  
  public default <T> T getObject(Name name,Class<T> clazz) {
    return getObject(name.getName(), clazz);
  }
  
  public default <T> T getObject(String name,Class<T> clazz) {
    return clazz.cast(objectByName().get(name));
  }
  
  public default Object getObject(Name name) {
    return getObject(name.getName());
  }
  
  public default Object getObject(String name) {
    return objectByName().get(name);
  }
  
  public default Parser putObject(Name name , Object object) {
    return putObject(name.getName(), object);
  }
  
  public default Parser putObject(String name , Object object) {
    objectByName().put(name, object);
    return this;
  }
  
  public default Parser putObject(Object object) {
    objectByName().put(object.getClass().getName(), object);
    return this;
  }
